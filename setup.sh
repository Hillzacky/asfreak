...
GITHUB=raw.githubusercontent.com/Hillzacky/asfreak/main

bash -c "$(curl -L https://${GITHUB}/lib/xray-core.sh)" - install --beta
...
mkdir -p /var/www/html/massxray >> /dev/null 2>&1
...
wget -q -O /etc/nginx/conf.d/grpc.conf "https://${GITHUB}/config/grpc.conf"

# wget -q -O /etc/nginx/nginx.conf "https://${GITHUB}/config/nginx.conf"
...
echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Utama${NC}"
...
wget -q -O massxray "https://${GITHUB}/menu/massxray.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Vmess${NC}"
wget -q -O add-vmess "https://${GITHUB}/src/vmess/add-vmess.sh"
wget -q -O del-vmess "https://${GITHUB}/src/vmess/del-vmess.sh"
wget -q -O extend-vmess "https://${GITHUB}/src/vmess/extend-vmess.sh"
wget -q -O trialvmess "https://${GITHUB}/src/vmess/trialvmess.sh"
wget -q -O cek-vmess "https://${GITHUB}/src/vmess/cek-vmess.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Vless${NC}"
wget -q -O add-vless "https://${GITHUB}/src/vless/add-vless.sh"
wget -q -O del-vless "https://${GITHUB}/src/vless/del-vless.sh"
wget -q -O extend-vless "https://${GITHUB}/src/vless/extend-vless.sh"
wget -q -O trialvless "https://${GITHUB}/src/vless/trialvless.sh"
wget -q -O cek-vless "https://${GITHUB}/src/vless/cek-vless.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Trojan${NC}"
wget -q -O add-trojan "https://${GITHUB}/src/trojan/add-trojan.sh"
wget -q -O del-trojan "https://${GITHUB}/src/trojan/del-trojan.sh"
wget -q -O extend-trojan "https://${GITHUB}/src/trojan/extend-trojan.sh"
wget -q -O trialtrojan "https://${GITHUB}/src/trojan/trialtrojan.sh"
wget -q -O cek-trojan "https://${GITHUB}/src/trojan/cek-trojan.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Shadowsocks${NC}"
wget -q -O add-ss "https://${GITHUB}/src/ss/add-ss.sh"
wget -q -O del-ss "https://${GITHUB}/src/ss/del-ss.sh"
wget -q -O extend-ss "https://${GITHUB}/src/ss/extend-ss.sh"
wget -q -O trialss "https://${GITHUB}/src/ss/trialss.sh"
wget -q -O cek-ss "https://${GITHUB}/src/ss/cek-ss.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Shadowsocks 2022${NC}"
wget -q -O add-ss2022 "https://${GITHUB}/src/ss2022/add-ss2022.sh"
wget -q -O del-ss2022 "https://${GITHUB}/src/ss2022/del-ss2022.sh"
wget -q -O extend-ss2022 "https://${GITHUB}/src/ss2022/extend-ss2022.sh"
wget -q -O trialss2022 "https://${GITHUB}/src/ss2022/trialss2022.sh"
wget -q -O cek-ss2022 "https://${GITHUB}/src/ss2022/cek-ss2022.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Mass Xray${NC}"
wget -q -O add-xray "https://${GITHUB}/src/massxray/add-xray.sh"
wget -q -O del-xray "https://${GITHUB}/src/massxray/del-xray.sh"
wget -q -O extend-xray "https://${GITHUB}/src/massxray/extend-xray.sh"
wget -q -O trialxray "https://${GITHUB}/src/massxray/trialxray.sh"
wget -q -O cek-xray "https://${GITHUB}/src/massxray/cek-xray.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Menu Catatan Aktivitas${NC}"
...
wget -q -O log-massxray "https://${GITHUB}/log/log-massxray.sh"
sleep 0.5

echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Pustaka${NC}"
wget -q -O xp "https://${GITHUB}/lib/xp.sh"
wget -q -O dns "https://${GITHUB}/lib/dns.sh"
wget -q -O certxray "https://${GITHUB}/lib/certxray.sh"
wget -q -O about "https://${GITHUB}/lib/about.sh"
wget -q -O clear-log "https://${GITHUB}/lib/clear-log.sh"
wget -q -O changer "https://${GITHUB}/lib/changer.sh"
echo -e "${GB}[ INFO ]${NC} ${YB}Pengunduhan Selesai${NC}"
sleep 2
chmod +x add-vmess
chmod +x del-vmess
...
echo -e "${YB}[ WARNING ] Mulai ulang server? (Y/N)${NC} "
read answer
